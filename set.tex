...
%\lstset{caption=and4.vhdl,label=and4}
%\lstinputlisting{src/and4.vhdl}

%\lstset{caption=invert.vhdl,label=invert}
%\lstinputlisting{src/invert.vhdl}

%\lstset{caption=decoder.vhdl,label=decoder}
%\lstinputlisting{src/decoder.vhdl}

%\lstset{caption=Testbench.vhdl,label=testbench}
%\lstinputlisting{src/Testbench.vhdl}
